...
class GroupAdvOption extends OptionAbstract {
	...
	public function get_option_label(): string {
		...
		/* translators: %1$s and %3$s: anchor opening tags, %2$s and %4$s: anchor closing tags */
			__( 'The plugin in the PRO version allows you to assign groups to specific categories or tags and to all products. You can also set the order in which the field groups are arranged. %1$sRead the documentation%2$s &nbsp; %3$sUpgrade to PRO%4$s', 'flexible-product-fields' ),
