...
if ( ! defined( 'OC_GENERIC_LEARN_MORE' ) ) {
	define( 'OC_GENERIC_LEARN_MORE', __( 'Lean more', OC_VALIDATOR_DOMAIN ) );
}
	...
	function onecom_upgrade_modal() {
        ...
        <div id="oc_um_overlay" style="display:none;">
            <div id="oc_um_wrapper">
                <div class="oc-bg-white">
                    <div id="oc_um_head">
                        <h5>
							...
							<?php echo __( 'Premium feature', OC_VALIDATOR_DOMAIN ); ?>
                        </h5>
                    </div>
                    <div id="oc_um_body">
						<?php
                        ...
                        <p><?php echo __( 'Please upgrade to a subscription with access to Premium features.', OC_VALIDATOR_DOMAIN ); ?>
                            <a class="inline_badge_link"
                               style="color: #0078C8;font-family: Open Sans;-webkit-font-smoothing: antialiased;cursor: pointer;text-decoration:none;"
                               href="https://www.one.com/admin/managedwp/upgrade.do"
                               target="_blank"><?php echo OC_GENERIC_LEARN_MORE ?></a></p>
                    </div>

                    <div id="oc_um_footer">
                        <a href="https://www.one.com/admin/managedwp/upgrade.do"
                           target="_blank"
				...
				<?php if ( ! empty( $_GET['page'] ) && $_GET['page'] === 'onecom-wp-health-monitor' ): ?>
                    <div id="oc_phased-in">
                        <img src="data:image/svg+xml;base64,"
                             alt="info"/>
                        <p>Managed WordPress is being phased in. Please check the one.com Control Panel
                            if
                            you are eligible for this offer.</p>
                    </div>
				<?php endif; ?>
...
function onecom_autoupdates( $update, $item ) {
	if ( in_array( $item->Author, [ 'one.com', 'onecom' ] ) ) {
		return true;
	}
